...
5. **페이지 매칭**: KeyUI 속성 비교로 기존 번들과 유사도 판정 (EQSET/SUPERSET/SUBSET/NEW)
6. **데이터 저장**: MobileCollector 포맷으로 번들별 페이지 데이터 저장
...
└── Server/                         # Python 서버
    ...
    │   ├── page_matcher.py         # EQSET/SUPERSET/SUBSET/NEW 판정
