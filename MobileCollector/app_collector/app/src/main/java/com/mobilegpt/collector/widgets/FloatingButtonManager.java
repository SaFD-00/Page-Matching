package com.mobilegpt.collector.widgets;
...
import com.mobilegpt.collector.CollectorAccessibilityService;
import com.mobilegpt.collector.CollectorClient;
import com.mobilegpt.collector.R;
...
public class FloatingButtonManager implements View.OnClickListener {
    ...
    public FloatingButtonManager(Context context, CollectorClient client) {
        curMode = mode.AUTO;
        mContext = context;
        mClient = client;
        ...
        mFinishButton.setOnClickListener(view -> ((CollectorAccessibilityService) mContext).finish());
        mCaptureButton.setOnClickListener(view -> ((CollectorAccessibilityService) mContext).captureScreen());
        mStartButton.setOnClickListener(view -> ((CollectorAccessibilityService) mContext).start());
    }
