"""Tests for mobilecollector.graphs.nodes (supervisor and explore_action)."""

import pytest

from mobilecollector.graphs.nodes.supervisor_node import supervisor_node, route_supervisor
from mobilecollector.graphs.nodes.explore_action_node import explore_action_node
